...
namespace Alex_dammyDiscrimination
{
    ...
    static class ACTInitSetting
    {
        ...
        // 設定ファイル保存先パス
        static String settingsFile = Path.Combine(ActGlobals.oFormActMain.AppDataFolder.FullName, "Config\\Alex_dammyDiscrimination.config.xml");
        ...
        {
            String str = ActGlobals.oFormActMain.AppDataFolder.FullName + "Config\\Alex_dammyDiscrimination.config.xml";
